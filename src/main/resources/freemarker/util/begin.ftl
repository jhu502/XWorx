...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
    <base id="basehref" href="<%=com.flame.xui.HREFactory.getBaseHREF(request)%>">

    <link href="css/flame/easyui/easyui.css" rel="stylesheet"/>
    <link href="css/flame/easyui/tabs.css" rel="stylesheet"/>
    <link href="css/flame/themes-icon.css" rel="stylesheet"/>
