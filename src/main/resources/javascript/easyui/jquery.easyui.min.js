...
if(_9a.icon) { // XWorx img
$("<div class=\"l-btn-icon\">&nbsp;<img src='"+_9a.icon+"' style='position:absolute;margin-left:-8px'></div>").appendTo(_9b);
...
if(_ed(_f3,dest).state$_=="closed"){
...
var item=_1cf[i];
if(item.state$_!="open"&&item.state$_!="closed"){
item.state="open";
}
...
cc.push("<ul style=\"display:"+(item.state$_=="closed"?"none":"block")+"\">");
cc=cc.concat(tmp);
cc.push("</ul>");
}
cc.push("</li>");
...
if(item.state$_=="open"&&!(item.children&&item.children.length)){
return true;
}
}else{
return true;
...
$.fn.tree.defaults={url:null,method:"post",animate:false,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,lines:false,dnd:false,editorHeight:22,data:null,queryParams:{},formatter:function(node){
return node.text;
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:24,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_3c5){
...
var item=$(div);
var _44b=$.extend({},$.parser.parseOptions(item[0],["id","name","iconCls","icon","href",{separator:"boolean"}]),{disabled:(item.attr("disabled")?true:undefined),text:$.trim(item.html()),onclick:item[0].onclick},_44a||{});
...
if(_44b.icon){ // XWorx img
$("<div class=\"menu-icon\"></div>").prepend("<img src=\""+_44b.icon+"\"/>").appendTo(item);
}else if(_44b.iconCls){
...
if(_48a.icon){ // XWorx img
$("<div class=\"menu-icon\"></div>").prepend("<img src=\""+_48a.icon+"\"/>").appendTo(item);
}else if(_48a.iconCls){
...
$.fn.menu.defaults={zIndex:110000,left:0,top:0,alignTo:null,align:"left",minWidth:150,itemHeight:22,duration:100,hideOnUnhover:true,inline:false,fit:false,noline:false,events:{mouseenter:_457,mouseleave:_45a,mouseover:_45e,mouseout:_461,click:_463},position:function(_494,left,top){
return {left:left,top:top};
},onShow:function(){
},onHide:function(){
...
_4ac.animate=false;
t.tree(item.state$_=="open"?"expand":"collapse",node.target);
_4ac.animate=_4ad;
}
});
};
...
var data=opts.data;
for(var i=0;i<data.length;i++){
acc.accordion("add",{title:data[i].text,selected:data[i].state$_=="open",iconCls:data[i].iconCls,onBeforeExpand:function(){
...
$.fn.menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,hasDownArrow:true,menu:null,menuAlign:"left",duration:100,showEvent:"click",hideEvent:"mouseleave",cls:{btn1:"m-btn-active",btn2:"m-btn-plain-active",arrow:"m-btn-downarrow",trigger:"m-btn"}});
})(jQuery);
(function($){
function init(_4d1){
...
cc.push(" name=\"selected_"+_914+"\" value=\""+(_915!=undefined?_915:"")+"\">");
}else{
if(col.formatter){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",resizeEdge:5,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",emptyMsg:"",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollOnSelect:true,scrollbarSize:18,rownumberWidth:30,editorHeight:22,headerEvents:{mouseover:_785(true),mouseout:_785(false),click:_789,dblclick:_78e,contextmenu:_791},rowEvents:{mouseover:_793(true),mouseout:_793(false),click:_79a,dblclick:_7a4,contextmenu:_7a8},rowStyler:function(_944,_945){
...
var row=_a96[i];
if(row.state$_!="open"&&row.state$_!="closed"){
row.state="open";
}
...
var v=row.state$_=="closed"?"none":"block";
...
if(opts.onlyLeafCheck){
if(row.state$_=="open"&&!(row.children&&row.children.length)){
return true;
}
}else{
return true;
