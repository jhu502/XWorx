...
public class FlowConstant {
    ...
    public static final String X_ROUTE = "x-route";
    public static final String X_EVENT = "x-event";
    public static final String X_ACTOR = "x-actor";
    public static final String X_NODE = "x-node";
    public static final String X_TIMER = "x-timer";
    public static final String X_VARIABLE = "x-variable";
    public static final String X_EXPRESSION = "x-expression";
