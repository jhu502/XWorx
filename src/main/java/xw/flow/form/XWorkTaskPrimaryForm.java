...
@UIMeshGrid(grids = {
        @UIGrid(provider = XWorkTask.class, rows = { //
                ...
                @UIRow(cells = { //
                        @UICell(label = "label_instructions", colspan = 3, widget = { //
                ...
                @UIRow(cells = { //
                        ...
                        @UICell(widget = { //
                                @UIWidget(type = WidgetType.Button, id = "completeTask", name = "taskRoutes", text = "Complete Task", style = "margin-left:8px", events = { //
