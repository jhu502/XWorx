 ...
 */
public class XFlowEngineAgenda extends DefaultFlowableEngineAgenda {
    public static class XFlowEngineAgendaFactory implements FlowableEngineAgendaFactory {
        @Override
        public FlowableEngineAgenda createAgenda(CommandContext commandContext) {
            return new XFlowEngineAgenda(commandContext);
        }
    }

    public XFlowEngineAgenda(CommandContext commandContext) {
