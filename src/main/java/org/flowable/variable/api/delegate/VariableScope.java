...
public interface VariableScope extends VariableContainer {
    ...
    /**
     * 用来临时存放XWorx Flow变量FlowVariable进行VariableScope中, 避免使用transientVariables时自动持久化
     * @param name
     * @param variable
     */
    default void setFlowVariable(String name, Object variable) {}

    default void clearFlowVariable() {};

    default Object getFlowVariable(String name) {return null;}

    default Map<String, Object> getFlowVariables() {
