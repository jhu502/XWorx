...
public class ExecutionEntityImpl extends AbstractBpmnEngineVariableScopeEntity implements ExecutionEntity, CountingExecutionEntity {
    ...
    /**
     * XFlow定制：用来临时存放其他对象, 例如:XWorkActivity
     */
    private transient Object externalObject;
    /**
     * XFlow定制：用来存放流程执行过程中, 流程实例、节点实例的变量值
     */
    private transient Map<String, Object> flowVariableMap = new HashMap<>();
    ...
    public void clearFlowVariable() {
        this.flowVariableMap.clear();
    }

    public void setFlowVariable(String name, Object variable) {
        this.flowVariableMap.put(name, variable);
    }

    public Object getFlowVariable(String name) {
        return this.flowVariableMap.get(name);
    }

    public Map<String, Object> getFlowVariables() {
        return this.flowVariableMap;
    }
